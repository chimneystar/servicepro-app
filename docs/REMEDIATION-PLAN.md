...
| 4.7 | Pagination on `/jobs`, `/schedule`, `/messages`, dashboard, reports | DONE (reports was already done under 2.4/2.8) |
| 4.8 | Booking: timezone support; polygon service areas | TODO |
| 4.9 | Reminders: mark sent AFTER send; allow retry | DONE |
| 4.10 | Surface swallowed errors (26 discarding call sites, 21 void actions) | DONE (25 call sites found and fixed across 18 files; 10 void actions in `/operations` + `/growth`) |
