 ...
 *
 * `status` is annotated with the three values it can produce, which are three
 * of the four `staff_notifications.delivery_status` allows. Inferred as
 * `string` it cannot be written to that column at all.
 *
 * @returns {{ ok: boolean, reached: string[], status: "sent" | "inbox_only" | "failed" }}
 */
