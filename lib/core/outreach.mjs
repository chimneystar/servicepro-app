...
export function contactEligibility(customer, channel) {
  ...
  if (channel === "sms") {
    ...
    if (typeof customer.sms_opt_in !== "boolean") return { ok: false, reason: "sms_opt_in_unknown" };
  ...
  if (typeof customer.email_opt_in !== "boolean") return { ok: false, reason: "email_opt_in_unknown" };
