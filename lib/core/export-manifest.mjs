...
export const EXCLUDED_TABLES = [
  {
    table: "merchant_secrets",
    reason:
      "Encrypted payment-provider API token. A credential, and useless outside this deployment's key.",
  },
  { table: "payment_checkout_secrets", reason: "Short-lived checkout session credentials." },
  {
    table: "webhook_events",
    reason:
      "Raw provider callbacks. The table has no organization_id, so no row can honestly be attributed to your business.",
  },
