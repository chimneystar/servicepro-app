 ...
 */
export function optionTotals(option, { discountMinor = 0, taxRateBps = 0, taxExempt = false } = {}) {
...
export function optionDepositMinor({ optionDeposit, estimateDeposit, totalMinor }) {
  ...
  const requested = finite(optionDeposit) > 0 ? finite(optionDeposit) : Math.max(0, finite(estimateDeposit));
