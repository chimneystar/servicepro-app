...
/** @typedef {{key?: string, enabled?: boolean, rollout_percent?: number|string, organization_allowlist?: string[]|null, organization_blocklist?: string[]|null}} FlagRow */
...
export function evaluateFlag(flag, organizationId, fallback) {
  if (typeof fallback !== "boolean") throw new TypeError("evaluateFlag requires an explicit boolean fallback");
...
export const KNOWN_FLAGS = Object.freeze({
  ...
  growth_outreach: { fallback: true, description: "Send scheduled campaigns and estimate follow-ups" },
});
