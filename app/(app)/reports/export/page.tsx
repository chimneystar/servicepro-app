...
export default async function ExportPage() {
  ...
  return (
    <div>
      ...
      <p style={{ color: "#5c6675", fontSize: "0.8125rem", marginBottom: 16 }}>Download your books for QuickBooks or your accountant — or take a complete copy of the whole business.</p>

      <h2 style={{ fontSize: "0.9375rem", fontWeight: 800, margin: "18px 0 8px", color: "#0f2a5e" }}>Accounting export</h2>
      <ExportClient />

      <h2 style={{ fontSize: "0.9375rem", fontWeight: 800, margin: "26px 0 8px", color: "#0f2a5e" }}>Whole-business export</h2>
      {profile.role !== "owner" ? (
        <div style={{ maxWidth: 560, background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 14, padding: 18, color: "#5c6675", fontSize: "0.8125rem" }}>
        ...
        <div style={{ maxWidth: 560, background: "#fff", border: "1px solid #e2e8f0", borderRadius: 14, padding: 18, boxShadow: "0 6px 18px rgba(15,42,94,.06)" }}>
          <p style={{ fontSize: "0.8125rem", color: "#334155", marginBottom: 12, lineHeight: 1.55 }}>
          ...
          <a
            ...
            download
            style={{ display: "block", textAlign: "center", background: "#2563eb", color: "#fff", borderRadius: 10, padding: "12px 16px", fontWeight: 700, fontSize: "0.875rem", textDecoration: "none" }}
          >
            ⬇ Download everything (.json)
          </a>

          <div style={{ background: "#fff7ed", border: "1px solid #fed7aa", color: "#7c2d12", borderRadius: 12, padding: "11px 14px", fontSize: "0.8125rem", marginTop: 14, lineHeight: 1.55 }}>
