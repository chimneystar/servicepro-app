...
export default async function ExportPage() {
  ...
  return (
    <div>
      ...
      <h2
        style={{ fontSize: "0.9375rem", fontWeight: 800, margin: "18px 0 8px", color: "#0f2a5e" }}
      >
        Accounting export
      </h2>
      <ExportClient />
      ...
      <h2
        style={{ fontSize: "0.9375rem", fontWeight: 800, margin: "26px 0 8px", color: "#0f2a5e" }}
      >
        Whole-business export
      </h2>
      {profile.role !== "owner" ? (
        <div
          style={{
        ...
        >
          ...
          file — can only be downloaded by the owner.
        </div>
      ) : (
        <div
          style={{
        ...
        >
          <p style={{ fontSize: "0.875rem", color: "#334155", marginBottom: 12, lineHeight: 1.55 }}>
            ...
            inventory, purchase orders, messages, calls, consent history, settings and the full
            audit trail. It is <b>paginated</b>, so it does not stop at 1,000 rows the way an
            ordinary query does.
          </p>
          ...
          <div style={{ color: "#5c6675", fontSize: "0.875rem", marginTop: 10, lineHeight: 1.55 }}>
            ...
            at the end reads <b>complete</b>. If the file will not open as JSON the download was
            interrupted — start it again.
          </div>
        </div>
      )}
