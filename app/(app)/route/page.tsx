...
export default async function RoutePage({
  ...
  const mapsRoute = withAddr.length
    ? "https://www.google.com/maps/dir/" + withAddr.map((s) => encodeURIComponent(s.addr)).join("/")
    : null;
  ...
  return (
    <div style={{ maxWidth: 760 }}>
      ...
      {mapsRoute && (
        ...
        >
          🗺️ Open full route in Google Maps ({withAddr.length} stops)
        </a>
      )}
          ...
          >
            ...
            <div className="sp-flex-fill">
              ...
              <div style={{ display: "flex", gap: 14, marginTop: 6 }}>
                ...
                {s.addr && (
                  <a
                    href={"https://maps.google.com/?q=" + encodeURIComponent(s.addr)}
                    target="_blank"
                    style={clink}
                  >
                    🧭 Navigate
                ...
                {s.phone && (
                  <a href={"tel:" + s.phone.replace(/[^0-9+]/g, "")} style={clink}>
                    📞 Call
                  </a>
                )}
              </div>
