      ...
      {open && (
        <Modal onClose={() => setOpen(false)} labelledBy={titleId} width={500}>
          <form action={formAction}>
            <h3 id={titleId} style={{ fontSize: "1.125rem", fontWeight: 800, marginBottom: 14 }}>{t(locale, "sched.new")}</h3>
            ...
            <div style={{ fontSize: "0.75rem", fontWeight: 700, color: "#5c6675", margin: "12px 0 6px" }}>Job address (leave blank to use client address)</div>
