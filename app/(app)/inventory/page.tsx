...
export default async function InventoryPage() {
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      <p style={{ color: "#5c6675", fontSize: 13, marginBottom: 14 }}>{he ? "מעקב אחרי חלקים וחומרים, כולל התראה לפני שנגמר." : "Track parts and materials, including low-stock alerts."}</p>
