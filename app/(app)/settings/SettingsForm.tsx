  ...
  return (
    <form action={formAction} style={{ display: "grid", gap: 16 }}>
      ...
      <Section title={he ? "עיצוב ותנאים במסמכים" : "Document design & terms"} note={he ? "אותם צבעים ותנאים יופיעו בהצעות המחיר ובחשבוניות שלך." : "These colors and terms appear on estimates and invoices."}>
        ...
        <div style={{ overflow: "hidden", marginBottom: 16, border: "1px solid #dde5f0", borderRadius: 13 }}><div style={{ padding: "11px 14px", background: accent, color: "#fff", fontSize: 13, fontWeight: 800 }}>{he ? "כך ייראה הצבע במסמכים שלך" : "This is how the color appears on your documents"}</div></div>
...
const successStyle: React.CSSProperties = { padding: "11px 13px", borderRadius: 12, background: "#e3faf4", color: "#087d65", fontSize: 13, fontWeight: 750 };
