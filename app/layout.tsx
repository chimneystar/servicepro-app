...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const theme = ["light", "dark", "system"].includes(cookieStore.get("ui_theme")?.value ?? "")
    ? cookieStore.get("ui_theme")!.value
    : "system";
  ...
  return (
    ...
    >
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Heebo:wght@400;500;600;700;800;900&family=Rubik:wght@600;700;800&display=swap"
          rel="stylesheet"
        />
