  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap", marginBottom: 14 }}>
        ...
        <button onClick={exportCsv} style={{ background: "#2563eb", color: "#fff", border: "none", borderRadius: 10, padding: "9px 14px", fontWeight: 700, fontSize: "0.875rem", cursor: "pointer" }}>⬇ Export CSV</button>
          ...
          return (
            <div key={r.profileId} style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 14, padding: 16 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                {canEditPct && <button onClick={() => savePct(r.profileId)} disabled={pending} style={{ background: "#eef2f8", color: "#2563eb", border: "none", borderRadius: 8, padding: "7px 12px", fontWeight: 700, fontSize: "0.8125rem", cursor: "pointer" }}>{saved === r.profileId ? "✓ Saved" : "Save %"}</button>}
              </div>
            </div>
          );
        })}
