...
export default function ShareDoc({ target, onClose }: { target: ShareTarget; onClose: () => void }) {
  ...
  return (
    <Modal onClose={onClose} labelledBy={titleId} width={420}>
      <h3 id={titleId} style={{ fontSize: "1.125rem", fontWeight: 800, marginBottom: 4 }}>Send {label} #{target.number}</h3>
      ...
      <div style={{ marginTop: 14, borderTop: "1px solid #eef1f6", paddingTop: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <input readOnly value={link} style={{ ...inp, fontSize: "0.8125rem", color: "#5c6675" }} aria-label="Shareable link" />
