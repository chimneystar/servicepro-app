  ...
  return (
    <Modal onClose={onClose} labelledBy={titleId} width={420}>
      ...
      <div style={{ marginTop: 14, borderTop: "1px solid #eef1f6", paddingTop: 12 }}>
        <div style={{ fontSize: "0.75rem", color: "#5c6675", marginBottom: 6 }}>
          Or copy the link and paste it anywhere:
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          <input
            readOnly
            value={link}
            style={{ ...inp, fontSize: "0.8125rem", color: "#5c6675" }}
      ...
      <p style={{ fontSize: "0.8125rem", color: "#94a3b8", marginTop: 10, textAlign: "center" }}>
        Opens your own email/messages app with everything pre-filled. Automatic 1-click sending
        comes when you connect an email/SMS provider.
      </p>
    </Modal>
  );
}
