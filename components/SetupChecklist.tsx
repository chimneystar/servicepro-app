  ...
  return (
    <div className="pop-in" style={{ background: "linear-gradient(135deg,#0f2a5e,#2563eb)", color: "#fff", borderRadius: 16, padding: 18, marginBottom: 16, boxShadow: "0 18px 50px rgba(15,42,94,.18)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
        ...
        <button onClick={() => run(() => dismissOnboarding(), () => router.refresh())} disabled={pending} style={{ background: "rgba(255,255,255,.18)", color: "#fff", border: "none", borderRadius: 8, padding: "6px 10px", fontWeight: 700, fontSize: "0.75rem", cursor: "pointer" }}>{he ? "הסתרה" : "Dismiss"}</button>
      </div>
