    ...
    <svg viewBox="0 0 24 24" aria-hidden="true" {...common} {...props}>
      ...
      {name === "customers" && (
        <>
          ...
          <path d="M17 11a3.5 3.5 0 1 0 0-7M22 20v-1.5a4.5 4.5 0 0 0-3-4.24" />
        </>
      )}
      {name === "messages" && (
        <>
      ...
      {name === "recurring" && (
        <>
          ...
          <path d="M19 12a7 7 0 0 0-12-5L4 10M5 12a7 7 0 0 0 12 5l3-3" />
        </>
      )}
      {name === "inventory" && (
        <>
      ...
      {name === "tools" && (
        <>
          <path d="m14.7 6.3 3-3a4 4 0 0 1-5 5l-7.9 7.9a2 2 0 1 0 2.8 2.8l7.9-7.9a4 4 0 0 1 5-5l-3 3z" />
        </>
      )}
      {name === "search" && (
        <>
      ...
      {name === "payments" && (
        <>
          ...
          <path d="M3 10h18M7 15h3M16 14v2M15 15h2" />
        </>
      )}
      {name === "finance" && (
        <>
          <path d="M3 20h18M5 20v-9M10 20V7M15 20v-5M20 20V4" />
          <path d="m4 7 5-4 5 6 6-6" />
        </>
      )}
      {name === "appearance" && (
        <>
