      ...
      {open && (
        <Modal onClose={() => setOpen(false)} labelledBy={titleId} width={460}>
          <form action={formAction}>
            <h3 id={titleId} style={{ fontSize: 18, fontWeight: 800, marginBottom: 12 }}>Edit customer</h3>
...
const editBtn: React.CSSProperties = { background: "#eef2f8", color: "#2563eb", border: "none", borderRadius: 9, padding: "7px 12px", fontWeight: 700, fontSize: 13, cursor: "pointer" };
...
const lbl: React.CSSProperties = { fontSize: 12.5, fontWeight: 700, color: "#334155", display: "block", margin: "9px 0 5px" };
