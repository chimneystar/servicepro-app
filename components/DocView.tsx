  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 16,
        overflow: "hidden",
        boxShadow: "0 8px 24px rgba(15,42,94,.07)",
      }}
    >
      <div
        style={{
      ...
      <div style={{ padding: "18px 24px" }}>
        ...
        <div style={{ borderTop: `2px solid ${accent}` }}>
          {items.map((it, i) => (
            ...
            >
              ...
              <b style={{ whiteSpace: "nowrap", fontSize: "0.875rem" }}>
                {money(line(it), currency)}
              </b>
            </div>
          ))}
        </div>
        ...
        <div style={{ marginTop: 12, marginInlineStart: "auto", maxWidth: 260 }}>
          ...
          {totals.discountMinor > 0 && (
            <Row label="Discount" value={"-" + money(totals.discountMinor, currency)} red />
          )}
          <Row
            label={`${taxLabel} (${taxRateBps / 100}%)`}
            value={money(totals.taxMinor, currency)}
          />
          <div
            style={{
              display: "flex",
          ...
          >
            <span>Total</span>
            <span>{money(totals.totalMinor, currency)}</span>
          </div>
        </div>
