  ...
  return (
    <div>
      <div style={{ position: "relative", marginBottom: 12 }}>
        <span aria-hidden="true" style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", fontSize: 15, color: "#94a3b8" }}>🔍</span>
        <input
          value={q}
      ...
      <div className="rlist">
        {filtered.map((c) => (
          <Link className="ritem" href={`/customers/${c.id}`} key={c.id}>
            ...
            <span aria-hidden="true" style={{ color: "#b6bfcc", fontSize: 18 }}>›</span>
          </Link>
        ))}
