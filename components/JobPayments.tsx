...
const REF_LABEL: Record<string, string> = {
  ...
  "Bank transfer": "Transfer / wire reference",
};
  ...
  if (invoices.length === 0)
    return (
      <div className="rempty">
        No invoices for this job yet. Create one in the Items or Invoices tab, then record payments
        here.
      </div>
    );
                ...
                <span
                  ...
                  style={
                    bal <= 0
                      ...
                      : { background: "#fdf1dc", color: "#b45309" }
                  }
                >
                  {bal <= 0 ? "Paid" : `${money(bal, currency)} due`}
                </span>
              </div>
